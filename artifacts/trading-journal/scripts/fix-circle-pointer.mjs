...
// SVG ellipse paths: use first point as center and second point as radius point.
s = s.replace(
...
console.log('[circle-fix] TradingView circle: center -> drag radius -> release; circular rendering and hit-testing aligned');
