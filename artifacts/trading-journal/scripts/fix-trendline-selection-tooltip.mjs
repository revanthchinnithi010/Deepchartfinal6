...
if (src.includes("data-chart-drawing-info-tooltip")) {
  // Tooltip already exists; make the requested field removal idempotently.
  ...
  console.log("[drawing-tooltip] Tooltip already installed; removed only Point 1/2, Locked and Visible.");
  process.exit(0);
}
...
fs.writeFileSync(file, src);
console.log("[drawing-tooltip] Installed selected trendline + rectangle info tooltip without Point 1/2, Locked or Visible fields.");
