...
// The old observer scanned the entire body on every mutation, causing repeated work and
// making the mobile Drawing Tools sheet appear to reload each time it opened.
